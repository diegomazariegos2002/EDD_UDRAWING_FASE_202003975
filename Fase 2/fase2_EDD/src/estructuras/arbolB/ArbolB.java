...
/**
 * IMPORTANTE Recordatorio: en este tipo de árbol los nodos tiene dos punteros su hijoIzq y su hijoDer
 * pero hay que recordar que los hijoDer en los nodos que no sean los últimos de sus páginas correspondientes
 * no importan. Esto por la norma de que una página solo puede tener un máximo de páginas como sea su número de orden.
 * Por ejemplo si el árbol es de orden 5 cada página puede tener como máximo 5 páginas hijas. Graficar para entender mejor esto también.
 * @author Melissa
 */
...
final int orden_arbol = 5;
    ...
    public String graficar_nodos(Pagina pagina){
        String cadena="";
    ...
    public String graficar_enlaces(Pagina pagina_Actual){
        String cadena="";
